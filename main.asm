...
wrxDriver:
; Total time from display driver entry to first display byte must be 174 T-states
...
;   - Load appropriate registers
        ...
        ld b,192 - 8                    ; [ 7] 184 lines for hi-res section        
...
wrxText:
; Total time from last hi-res display byte to Sinclair ROM driver call must be 155 T-states
...
; Total for following set-up section = 60
        ...
        ld hl,displayRoutine + $8002    ; [10]
        ld a,$1e                        ; [ 7] Point to our ROM character set
        ld i,a                          ; [ 9]
